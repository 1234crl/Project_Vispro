...
namespace Project_Vispro.View
{
    public partial class PeopleForm : Form
    {
        ...
        public PeopleForm(FormController control)
        {
            this.controller = control;
            InitializeComponent();
            SetUpDataGridView();

            this.addButon.Click += new System.EventHandler(controller.addPeopleButon_Click);
            this.Load += new System.EventHandler(controller.PeopleForm_Load);
        }

        //private void categoryPeopleBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        //{
        //    this.Validate();
        //    this.categoryPeopleBindingSource.EndEdit();
        //    this.tableAdapterManager.UpdateAll(this.budgetingManagementDataSet);
